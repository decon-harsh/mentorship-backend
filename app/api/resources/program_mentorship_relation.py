...
@program_mentorship_relation_ns.route("program_mentorship_relation/program/send_request")
class SendRequest(Resource):
    ...
    def post(cls):
        ...
        if "mentor_id" in data:
            ...
            mentee_id = None
            response = DAO.create_program_mentorship_relation(user_sender_id, org_rep_id, mentor_id, mentee_id, data)    
        # request to mentee
        else:
